...
st.set_page_config(
    page_title="NHS NEXED - Emergency Department Intelligence",
    page_icon="https://raw.githubusercontent.com/Mahfara/mediflow-ai/main/logo.png",
    layout="wide",
...
with st.sidebar:
    if logo_b64:
        ...
        <div style='padding:0.5rem 0 1rem'>
            <div style='display:flex;align-items:center;gap:12px'>
                ...
                <div>
                    <div style='color:#0f172a;font-size:17px;font-weight:700'>NHS NEXED</div>
                    <div style='color:#1e40af;font-size:10px;letter-spacing:0.15em;text-transform:uppercase;font-weight:600'>Next-Gen Emergency Department AI</div>
                </div>
            </div>
        </div>
    ...
    <div style='font-size:12px;color:#334155;margin-bottom:4px'>Breach AUC: 0.9231</div>
    <div style='font-size:12px;color:#334155;margin-bottom:4px'>Wait MAE: plus or minus 0.4 min</div>
    <div style='font-size:12px;color:#334155;margin-bottom:4px'>Accuracy: 86.85%</div>
...
if page == "Live Dashboard":
    ...
    k2.metric("Avg Wait to Assessment", f"{avg_wait:.0f} min", "Model MAE: plus or minus 0.4 min")
    ...
    st.markdown(f"""
    <div class="ai-box">
        <div class="section-title">NHS NEXED - Real Data Insights</div>
        ...
        if submit:
            ...
            <div class="result-box">
                ...
                <div style='font-size:12px;color:#64748b;line-height:1.6;border-top:1px solid #e2e8f0;padding-top:0.75rem'>
                    Model: LightGBM  |  AUC 0.9231  |  Accuracy 86.85%  |
                    Trained on {meta['total_records']:,} NHS ED records  |  Wait MAE plus or minus 0.4 min
                </div>
            </div>
            """, unsafe_allow_html=True)
...
# MODEL INFO
    ...
    k1, k2, k3, k4 = st.columns(4)
    k1.metric("Breach Model AUC", "0.9231")
    k2.metric("Accuracy", "86.85%")
    k3.metric("Wait Time MAE", "0.4 min (MAE)")
    k4.metric("Training Records", "70,000")
