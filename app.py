...
if page == "Live Dashboard":
    ...
    with c2:
        ...
        fig2.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="#f8fafc", font=dict(family="DM Sans", color="#334155", size=12), margin=dict(l=10, r=10, t=30, b=10), legend=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="#334155")), height=240,
    ...
    with c3:
        ...
        fig3.add_hline(y=breach_rate, line_dash="dash", line_color="#334155",
                       annotation_text=f"Annual avg {breach_rate:.1f}%")
        fig3.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="#f8fafc", font=dict(family="DM Sans", color="#334155", size=12), margin=dict(l=10, r=10, t=30, b=10), legend=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="#334155")), height=230, yaxis_title="Breach Rate %")
    ...
    with c4:
        ...
        fig4.add_hline(y=avg_wait, line_dash="dash", line_color="#334155",
                       annotation_text=f"Overall avg {avg_wait:.0f}m")
        fig4.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="#f8fafc", font=dict(family="DM Sans", color="#334155", size=12), margin=dict(l=10, r=10, t=30, b=10), legend=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="#334155")), height=230, yaxis_title="Avg Wait (min)",
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    with right:
        if submit:
            ...
            fig_g.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="#f8fafc", font=dict(family="DM Sans", color="#334155", size=12), margin=dict(l=10, r=10, t=30, b=10), legend=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="#334155")), height=200)
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    with c1:
        ...
        fig.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="#f8fafc", font=dict(family="DM Sans", color="#334155", size=12), margin=dict(l=10, r=10, t=30, b=10), legend=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="#334155")), height=280, yaxis_title="Wait Time (min)")
        st.plotly_chart(fig, use_container_width=True)
    ...
    with c2:
        ...
        fig2.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="#f8fafc", font=dict(family="DM Sans", color="#334155", size=12), margin=dict(l=10, r=10, t=30, b=10), legend=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="#334155")), height=280,
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    with c1:
        ...
        fig.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="#f8fafc", font=dict(family="DM Sans", color="#334155", size=12), margin=dict(l=10, r=10, t=30, b=10), legend=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="#334155")), height=250, coloraxis_showscale=False)
    ...
    with c2:
        ...
        fig2.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="#f8fafc", font=dict(family="DM Sans", color="#334155", size=12), margin=dict(l=10, r=10, t=30, b=10), legend=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="#334155")), height=300, xaxis_title="Avg ED LOS (min)")
        st.plotly_chart(fig2, use_container_width=True)
    ...
    fig_h = go.Figure(go.Heatmap(
        ...
        showscale=True, colorbar=dict(tickfont=dict(color="#334155")),
        hovertemplate="Day: %{y}<br>Hour: %{x}<br>Arrivals: %{z}<extra></extra>"
    ))
    fig_h.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="#f8fafc", font=dict(family="DM Sans", color="#334155", size=12), margin=dict(l=10, r=10, t=30, b=10), legend=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="#334155")), height=260)
    ...
    fig_t.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="#f8fafc", font=dict(family="DM Sans", color="#334155", size=12), margin=dict(l=10, r=10, t=30, b=10), legend=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="#334155")), height=290,
        yaxis=dict(gridcolor='#e2e8f0', zerolinecolor='rgba(0,0,0,0)',title="Breach Rate %"),
        yaxis2=dict(overlaying="y",side="right",title="Avg Wait (min)",
                    gridcolor="rgba(0,0,0,0)",color="#334155"),
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    fig_fi.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="#f8fafc", font=dict(family="DM Sans", color="#334155", size=12), margin=dict(l=10, r=10, t=30, b=10), legend=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="#334155")), height=380, xaxis_title="Feature Importance (Split gain)")
